...
# --------------------------------------------------------------
# Helper func: detect if any emergency vehicle exists in a given lane
# --------------------------------------------------------------
def has_emergency_vehicle(lane_vehicles):
    """
    Checks whether a list of vehicles in a lane contains
    any emergency vehicle.
    """
    for v in lane_vehicles:
        if hasattr(v, "vehicle_type") and v.vehicle_type == "emergency":
            return True
    return False